...
## 消息与事件[​](https://rocketmq.apache.org/zh/docs/eventbridge/02RocketMQEventBridgeOverview#%E6%B6%88%E6%81%AF%E4%B8%8E%E4%BA%8B%E4%BB%B6 "消息与事件的直接链接")
...
![[rocketmq/_resources/EventBridge/561e1cbf9567f751938f129842ceaaac_MD5.png]]
...
```
* 把厨房的灯打开* 去按下门铃* 转给A账户10w
```

Event，则是明确已经发生的事情。比如

```
* 厨房灯被打开了* 有人按了门铃* A账户收到了10w
```
...
```
什么时候发生的事件？谁产生的？是什么类型的事件？事件的内容是什么？内容的结构是什么？... ...
```
...
![[rocketmq/_resources/EventBridge/5cad854e7f0464fbe6f2637ca3173406_MD5.png]]
...
![[rocketmq/_resources/EventBridge/f81ccdec35e878d03c6f1241309186c3_MD5.png]]
...
![[rocketmq/_resources/EventBridge/1e3b80040ec6067210082c1c9cd0f735_MD5.png]]
